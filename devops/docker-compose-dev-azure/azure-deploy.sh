...
resourcename="canineconcierge"  # lower case, only
resourcegroup="canineconcierge_rg"
...
# git clone https://github.com/apilogicserver/canineconcierge.git
# cd canineconcierge
...
az group create --name canineconcierge_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group canineconcierge_rg --sku S1 --is-linux
az container create --resource-group canineconcierge_rg --name canineconcierge --image apilogicserver/canineconcierge:latest --dns-name-label canineconcierge --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//canineconcierge.westus.azurecontainer.io:5656'
